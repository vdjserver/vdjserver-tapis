...
if (__name__=="__main__"):
    ...
    if args:
        ...
        result['statistics'].append(junction_length('junction_length', args.repertoire_id + '.junction_nucleotide_length.tsv'))
        result['statistics'].append(junction_length('junction_aa_length', args.repertoire_id + '.junction_aa_length.tsv'))
        result['statistics'].append(junction_length('junction_length_productive', args.repertoire_id + '.productive.junction_nucleotide_length.tsv'))
