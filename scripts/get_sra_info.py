...
def parse_args_sraIdentifier():
    ...
    parser.add_argument('identifier', type=str, help = "SRA identifier")
...
if __name__ == "__main__":
    ...
    if args:
        try:
            tab = SRAUtils.getInfoFromSRAIdentifier(args.identifier)
            print(tab[0]['download_path'])
        except Exception as err:
            print ("Failed to get info for " + str(args.identifier) + ", mess: " + str(err), file=sys.stderr)
